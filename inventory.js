    ...
    rowElement.innerHTML = `
      <div>
        ...
        >
          ...
          <option value="P22 CEBOLLINO">P22 CEBOLLINO</option>
          ...
          <option value="P26 CEBOLLINO">P26 CEBOLLINO</option>
          <option value="P27 CEBOLLINO">P27 CEBOLLINO</option>
          <option value="P28 CEBOLLINO">P28 CEBOLLINO</option>
          ...
          <option value="P32 LIGUSTICO">P32 LIGUSTICO</option>
          ...
          <option value="P64 LIGUSTICO">P64 LIGUSTICO</option>
...
async function sendTelegramNotification(data) {
  const token = "7257790202:AAHhoHu17eVKt-ck0BheMvGVetf6KN2KMF4";
  const chatId = "-1002604314732";
